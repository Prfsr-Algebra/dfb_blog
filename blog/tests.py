...
class BlogTests(TestCase):
    ...
    def test_get_absolute_url(self):
        self.assertEqual(self.post.get_absolute_url(), reverse('post_details', args= '1'))
    ...
    def test_post_create_view(self):
        ...
        self.assertEqual(response.status_code, 200)
        self.assertContains(response, "create_view")
        self.assertContains(response, "it should work")
